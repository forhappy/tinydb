...
put(engine_base_t *engine,
	...
	size_t value_len)
{
	printf("hook call to mysql engine put.\n");
...
get(engine_base_t *engine,
	...
	size_t *value_len)
{
	printf("hook call to mysql engine get.\n");
...
delete(engine_base_t *engine,
	   ...
	   size_t key_len)
{
	printf("hook call to mysql engine delete.\n");

	return 0;
}

engine_base_t *
engine_mysql_init(void)
{
	...
	const char *engine_name = "mysql engine v0.1";

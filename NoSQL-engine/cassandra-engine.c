...
put(engine_base_t *engine,
	...
	size_t value_len)
{
	printf("hook call to cassandra engine put.\n");
...
get(engine_base_t *engine,
	...
	size_t *value_len)
{
	printf("hook call to cassandra engine get.\n");
...
delete(engine_base_t *engine,
	   ...
	   size_t key_len)
{
	printf("hook call to cassandra engine delete.\n");

	return 0;
}

engine_base_t *
engine_cassandra_init(void)
{
	...
	const char *engine_name = "cassandra engine v0.1";

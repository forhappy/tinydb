...
put(engine_base_t *engine,
	...
	size_t value_len)
{
	printf("hook call to mongodb engine put.\n");
...
get(engine_base_t *engine,
	...
	size_t *value_len)
{
	printf("hook call to mongodb engine get.\n");
...
delete(engine_base_t *engine,
	   ...
	   size_t key_len)
{
	printf("hook call to mongodb engine delete.\n");

	return 0;
}

engine_base_t *
engine_mongodb_init(void)
{
	...
	const char *engine_name = "mongodb engine v0.1";
